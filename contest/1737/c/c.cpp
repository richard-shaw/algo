...
int cor(int r1, int c1, int r2, int c2, int r3, int c3, int r, int c, int n) {
    int R = r1 + r2 + r3;
    int C = c1 + c2 + c3;
    if (r == 2 && c == 2) {
        if (R==4 && C == 4) return 1;
    ...
    if (r == 2 && c==n-1) {
        if (R == 4 && C == 3 * n - 1) return 2;
        else return 0;
    }
    if (r==n-1 && c == 2) {
        if (R == 3 * n - 1 && C == 4) return 3;
        else return 0;
    }
    if (r==n-1 && c==n-1) {
        if (R == 3 * n - 1 && C == 3 * n - 1) return 4;
        else return 0;
    }
    return 0;
}
...
void solve(int _case) {
    ...
    int k = cor(r1, c1, r2, c2, r3, c3, r, c, n);
    if (k == 1) {
        if (x == 1 || y == 1) YES;
        else NO;
    } else if (k == 2) {
